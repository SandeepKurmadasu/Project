...
def test_reset_otp_success(interactor, user_storage, snapshot):
    ...
    user_storage.reset_otp_count.return_value = expected

    result = interactor.reset_otp_count("U001")

    snapshot.assert_match(repr(result), "reset_otp_success.json")
