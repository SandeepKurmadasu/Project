...
class TestUserLearningPath:
    ...
    def test_get_user_learning_path_percentage_success(self, snapshot):
        # Arrange
        ...
        # Act
        result = interactor.get_user_learning_path_percentage(
            user_learning_path_id=user_learning_path_id)

        snapshot.assert_match(
            repr(result),
            "get_user_learning_path_percentage_success_snapshot.txt",
        )
    ...
    def test_get_user_learning_path_not_found(self, snapshot):
        ...
        with patch(
            ...
            with pytest.raises(UserLearningPathNotFound) as exc:
                interactor.get_user_learning_path_percentage(
