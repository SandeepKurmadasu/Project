...
class AssessmentNotFoundType(graphene.ObjectType):
    assessment_id = graphene.String(required=True)


class AssessmentUserNotFoundType(graphene.ObjectType):
    user_id = graphene.String(required=True)

class AlreadyAttemptedExistType(graphene.ObjectType):
    question_id = graphene.String(required=True)

class AttemptNotFoundType(graphene.ObjectType):
