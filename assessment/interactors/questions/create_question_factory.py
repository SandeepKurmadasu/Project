...
from assessment.interactors.dtos import CreateQuestionDTO, QuestionType, QuestionDTO
...
class QuestionFactory:
    ...
    @staticmethod
    def bulk_create_questions(questions: list[CreateQuestionDTO]) -> list[QuestionDTO]:
